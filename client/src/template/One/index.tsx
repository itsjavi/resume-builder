...
import { Education, Photo, Skills, WorkExperience } from './Elements';
  ...
  render () {
    ...
    return (
      <div className={styles.insideCon}>
        <div>
          <Text value={this.props.userData.name} statename="userData.name" placeholder="Your Name"
        ...
        {itemStatus.info && (
          <div className={[styles.info, styles.box].join(' ')}>
            <Text
              ...
              tag="div"
            />
            <Text value={this.props.userData.address} statename="userData.address"
